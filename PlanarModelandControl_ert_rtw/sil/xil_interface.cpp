 ...
 *
 * SIL generated interface for code: "PlanarModelandControl"
 *
 */
...
#define rtObj                          (*get_rtObj_ptr())

/* Accessor function to control initialization of model object */
PlanarModelandControl * get_rtObj_ptr(void)
{
  static PlanarModelandControl* xil_rtObj_ptr = new PlanarModelandControl();
  return xil_rtObj_ptr;
}
   ...
   case XIL_OUTPUT_COMMAND:
    {
      ...
      if (!initComplete) {
        ...
        {
          /* Logging address access: ay_cg */
          void * dataAddress = (void*)(& rtObj.rtDW.ay_cg);
          xil_fcnid0_task1_y[tableIdx].memUnitLength = 1 * sizeof(real_T);
          xil_fcnid0_task1_y[tableIdx++].address = (MemUnit_T *) dataAddress;
        }

        {
          /* Logging address access: yaw_rate */
          void * dataAddress = (void*)(& rtObj.rtDW.yaw_rate);
          xil_fcnid0_task1_y[tableIdx].memUnitLength = 1 * sizeof(real_T);
          xil_fcnid0_task1_y[tableIdx++].address = (MemUnit_T *) dataAddress;
        }
