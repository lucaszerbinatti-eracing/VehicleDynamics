...
## Generated on : Tue Aug 11 13:44:03 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/PlanarModelandControl
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/PlanarModelandControl
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/PlanarModelandControl_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
SRCS = $(START_DIR)/PlanarModelandControl_ert_rtw/PlanarModelandControl.cpp $(START_DIR)/PlanarModelandControl_ert_rtw/PlanarModelandControl_capi.cpp $(START_DIR)/PlanarModelandControl_ert_rtw/PlanarModelandControl_data.cpp

MAIN_SRC = $(START_DIR)/PlanarModelandControl_ert_rtw/ert_main.cpp
...
OBJS = PlanarModelandControl.o PlanarModelandControl_capi.o PlanarModelandControl_data.o
...
$(PRODUCT) : $(OBJS) $(PREBUILT_OBJS) $(MAIN_OBJ)
	...
	$(CPP_LD) $(CPP_LDFLAGS) -o $(PRODUCT) $(OBJS) $(MAIN_OBJ) -Wl,--start-group $(SYSTEM_LIBS) $(TOOLCHAIN_LIBS) -Wl,--end-group
...
%.o : $(START_DIR)/PlanarModelandControl_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/PlanarModelandControl_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/PlanarModelandControl_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/PlanarModelandControl_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/PlanarModelandControl_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
PlanarModelandControl.o : $(START_DIR)/PlanarModelandControl_ert_rtw/PlanarModelandControl.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


PlanarModelandControl_capi.o : $(START_DIR)/PlanarModelandControl_ert_rtw/PlanarModelandControl_capi.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


PlanarModelandControl_data.o : $(START_DIR)/PlanarModelandControl_ert_rtw/PlanarModelandControl_data.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/PlanarModelandControl_ert_rtw/ert_main.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
